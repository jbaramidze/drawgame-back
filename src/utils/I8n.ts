const map = new Map<string, {ge: string, en: string}>([
    ...
    ["waitingTillPeopleChoose", {ge: "ველოდებით როდის აარჩევენ.....", en: "Waiting for others to choose...."}],
    ["choosePicName",   {ge: "აარჩიე სურათის სახელი....", en: "Guess the original name of the pic"}],
    ["gameOver",        {ge: "დამთავრდა!",          en: "Game over!"}],
    ["score",           {ge: "ქულა",                en: "score"}],
    ["startOver",       {ge: "ახლიდან",             en: "Play again"}],
    ["waitingForOthersToName", {ge: "ველოდებით როდის მოუფიქრებენ სხვები სახელს.....",
                                en: "Waiting till others will think up a name for this....."}],
    ["accept",          {ge: "დაფიქსირება",         en: "accept"}],
    ["picBelongsToAndGotPoints",
        {ge: "ეს არის ",
        en: "This is "}],
